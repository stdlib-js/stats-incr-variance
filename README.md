...
```javascript
import incrvariance from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-variance@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-variance/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-incr-variance/actions/workflows/test.yml?query=branch:v0.2.1
